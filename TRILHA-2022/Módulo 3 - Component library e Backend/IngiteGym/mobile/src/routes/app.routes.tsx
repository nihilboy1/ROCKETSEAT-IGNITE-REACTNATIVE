  ...
  return (
    ...
    >
      <Screen
        ...
        options={{
          tabBarIcon: ({ color }) => (
            <HomeIconSvg fill={color} height={iconSize} width={iconSize} />
          ),
        }}
      />
      <Screen
        ...
        options={{
          tabBarIcon: ({ color }) => (
            <HistoryIconSvg fill={color} height={iconSize} width={iconSize} />
          ),
        }}
      />
      <Screen
      ...
      <Screen
        ...
        options={{
          tabBarIcon: ({ color }) => (
            <ProfileIconSvg fill={color} height={iconSize} width={iconSize} />
          ),
        }}
      />
    </Navigator>
